...
public class ColumnStatisticsEntity {
    ...
    // === Part 3: Extended Profiling Fields ===

    /** Inferred column data type (STRING / INTEGER / DECIMAL / BOOLEAN). */
    @Enumerated(EnumType.STRING)
    private DataType dataType;

    /** Stats for numeric columns (INTEGER/DECIMAL). Null for non-numeric columns. */
    private Integer numericCount;
    private Double numericMin;
    private Double numericMax;
    private Double numericMean;
    private Double numericMedian;
    private Double numericStddev;
}
